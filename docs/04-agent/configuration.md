...
| `responses_include` | Optional array of official Responses include values, for example `reasoning.encrypted_content`; compatible gateways may support different values. |
