...
description: Start the Aiden Config Web and Agent Web locally without a development board.
---
...
- [Try Aiden on PC](try-aiden-on-pc.md) for the Benchmark WebUI and recorded
  MobileGym runs;
- [Agent Configuration](../04-agent/configuration.md) for configuration fields;
- [Benchmark Overview](../09-benchmark/README.md) for suites, judging, and
  reports;
