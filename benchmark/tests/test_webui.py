...
def test_environment_bridge_screen_endpoint_normalizes_api_suffixes():
    assert webui.environment_bridge_screen_endpoint("http://127.0.0.1:19090/api/setup") == "http://127.0.0.1:19090/api/providers/screenshot"
    assert webui.environment_bridge_screen_endpoint("http://127.0.0.1:19090/api/release") == "http://127.0.0.1:19090/api/providers/screenshot"
    assert webui.environment_bridge_screen_endpoint("http://127.0.0.1:19090/api/concurrent") == "http://127.0.0.1:19090/api/providers/screenshot"
