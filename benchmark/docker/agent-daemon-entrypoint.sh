...
default_forward_tools="screenshot,touch_gesture,keyboard_text,keyboard_tap,enter_text,open_app,wait_for_stable_screen,mouse_click,mouse_move,mouse_scroll,wheel_nudge,quick_action,bridge_open_app,bridge_clipboard,bridge_calendar,bridge_contacts,bridge_notification"
