...
export const appState = {config:null,wifi:null,wifiStatus:null,agentStatus:null,agentLog:null,agentLogPendingSnapshot:null,agentLogAutoScroll:true,otaLog:null,otaLogVisible:false,otaLogPending:false,otaLogStartSize:0,systemEnv:'',networks:[],selectedSsid:'',wifiListExpanded:false,sttTest:{recording:false,busy:false}};
