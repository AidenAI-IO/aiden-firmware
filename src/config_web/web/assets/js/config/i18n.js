...
const messages = {
  'en-US': {
    ...
    'config.fields.model.api_mode.label': 'API Mode',
    'config.fields.model.api_mode.help': 'Chat Completions is the default. Responses API sends the locally managed conversation history to an OpenAI-compatible /responses endpoint and keeps store=false.',
  ...
  'zh-CN': {
    ...
    'config.fields.model.api_mode.label': '接口模式',
    'config.fields.model.api_mode.help': '默认使用 Chat Completions。Responses API 会将本地维护的对话历史发送到兼容 OpenAI 的 /responses 端点，并固定使用 store=false。',
