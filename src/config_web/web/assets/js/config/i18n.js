...
const messages = {
  'en-US': {
    ...
    'config.voice_model_qwen_only': "Current firmware connects this section to DashScope Qwen Realtime and attaches Aiden's realtime tools automatically.",
    ...
    'config.fields.voice_model.api_key.label': 'DashScope API Key',
    'config.fields.voice_model.api_key.placeholder': '$DASHSCOPE_API_KEY',
    'config.fields.voice_model.api_key.help': 'DashScope credential for the Qwen realtime session. Use a literal key or $ENV_VAR.',
    'config.fields.voice_model.model.label': 'Realtime Model',
    'config.fields.voice_model.model.help': 'DashScope Qwen realtime model ID.',
    'config.fields.voice_model.region.label': 'Region',
    'config.fields.voice_model.region.options.default': 'Automatic',
    'config.fields.voice_model.region.options.cn_beijing': 'China (Beijing)',
    'config.fields.voice_model.region.options.ap_southeast_1': 'Singapore',
    'config.fields.voice_model.voice.label': 'Voice',
    'config.fields.voice_model.voice.help': 'Qwen realtime system voice name or voice-clone ID.',
  ...
  'zh-CN': {
    ...
    'config.voice_model_qwen_only': '当前固件仅将此分区接入 DashScope Qwen Realtime；Aiden 会自动挂载 realtime 工具。',
    ...
    'config.fields.voice_model.api_key.label': 'DashScope API 密钥',
    'config.fields.voice_model.api_key.placeholder': '$DASHSCOPE_API_KEY',
    'config.fields.voice_model.api_key.help': 'Qwen 实时会话使用的 DashScope 凭据，可直接填写密钥或 $ENV_VAR。',
    'config.fields.voice_model.model.label': '实时模型',
    'config.fields.voice_model.model.help': 'DashScope Qwen 实时模型 ID。',
    'config.fields.voice_model.region.label': '地域',
    'config.fields.voice_model.region.options.default': '自动',
    'config.fields.voice_model.region.options.cn_beijing': '中国（北京）',
    'config.fields.voice_model.region.options.ap_southeast_1': '新加坡',
    'config.fields.voice_model.voice.label': '音色',
    'config.fields.voice_model.voice.help': 'Qwen 实时系统音色名称或声音复刻 ID。',
