...
const messages = {
  'en-US': {
    ...
    'config.fields.voice_model_providers.upstream_provider.options.openai': 'OpenAI Realtime',
    ...
    'config.fields.voice_model_providers.endpoint.label': 'Qwen WebSocket endpoint',
  ...
  'zh-CN': {
    ...
    'config.fields.voice_model_providers.workspace_id.label': 'DashScope Workspace ID',
    'config.fields.voice_model_providers.endpoint.label': 'Qwen WebSocket 地址',
    'config.fields.voice_model_providers.base_url.label': 'Provider Base URL',
