...
const messages = {
  'en-US': {
    ...
    'config.fields.device.device_type.help': 'Android exposes both a touchscreen and an absolute mouse with a visible cursor. iOS, macOS, windows, and linux use the absolute mouse.',
  ...
  'zh-CN': {
    ...
    'config.fields.device.device_type.help': 'Android 同时提供 touchscreen 和带可见指针的 absolute mouse。iOS、macOS、windows 和 linux 使用 absolute mouse。',
