...
const messages = {
  'en-US': {
    ...
    'config.fields.model.reasoning_effort.help': 'Empty = auto. Options follow the selected model capability; off is shown only when the model supports disabling reasoning.',
  ...
  'zh-CN': {
    ...
    'config.fields.model.reasoning_effort.help': '留空 = 自动。选项根据当前模型能力动态提供；仅支持关闭推理的模型显示 off。',
