...
const messages = {
  'en-US': {
    ...
    'config.fields.model.api_mode.help': 'Chat Completions is the default. Responses API can replay local context with store=false or chain provider-managed context with store=true and previous_response_id.',
  ...
  'zh-CN': {
    ...
    'config.fields.model.api_mode.help': '默认使用 Chat Completions。Responses API 支持 store=false 的本地上下文，也支持 store=true 加 previous_response_id 的提供商托管上下文。',
