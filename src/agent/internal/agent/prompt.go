...
func defaultAgentBehavior() string {
	rules := []string{
		...
		"- When invoking tools, begin assistant content with exactly one <tts>...</tts> block containing the concise progress text to speak aloud, followed by brief user-facing progress text. Content outside <tts> is not spoken. Do not put speech or description arguments in tool inputs. Do not put the final answer in tool-call assistant content.",
