...
func newHardwareToolSet(hidCfg HIDConfig, audioCfg AudioConfig, searchCfg SearchConfig, proxyCfg ProxyConfig, options ...BuiltinToolSetOption) *ToolSet {
	...
	tools := map[string]langtools.Tool{
		...
		"mouse_click":            newPostActionStableScreenshotToolWithTinyChangeRetry(mouseClick, waitStable, screenshot, postActionScreenshotDelay, screenStable),
		...
		"touch_gesture":          newPostActionStableScreenshotToolWithTinyChangeRetry(touchGesture, waitStable, screenshot, postActionScreenshotDelay, screenStable),
		"quick_action":           newPostActionStableScreenshotToolWithTinyChangeRetry(quickAction, waitStable, screenshot, postActionScreenshotDelay, screenStable),
		"screenshot":             screenshot,
