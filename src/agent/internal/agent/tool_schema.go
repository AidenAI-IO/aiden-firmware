...
func coordSpaceSchema() map[string]any {
	return stringEnumArgSchema("Coordinate space; screenshot uses pixels in the latest returned cropped screenshot, pixel uses the uncropped source frame, and normalized uses 0-1000 coordinates.", "auto", "screenshot", "pixel", "normalized", "absolute")
}
