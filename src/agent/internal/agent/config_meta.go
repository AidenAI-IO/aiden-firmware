		...
		Sections: []SectionMeta{
			...
			},
			{
				...
				Fields: []FieldMeta{
					...
					{Key: "dynamic_keyboard", Widget: WidgetBoolean, Default: defaults.HID.DynamicKeyboard,
						VisibleWhen: all(eq("hid.input_backend", "hid"))},
					{Key: "dynamic_keyboard_control", Widget: WidgetText, Default: defaults.HID.DynamicKeyboardControlOrDefault(),
						VisibleWhen: all(eq("hid.input_backend", "hid"), truthy("hid.dynamic_keyboard"))},
