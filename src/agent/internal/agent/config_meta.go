	...
	return ConfigMetadata{
		Sections: []SectionMeta{
				...
				Fields: []FieldMeta{
					...
					{Key: "model", Widget: WidgetSelect,
						Enum: []EnumOption{
							...
							{Value: "x-ai/grok-voice-tts-1.0", Label: "xAI Grok Voice"},
							{Value: "google/gemini-3.1-flash-tts-preview", Label: "Google Gemini TTS"},
							{Value: "zyphra/zonos-v0.1-transformer", Label: "Zyphra Zonos Transformer"},
							{Value: "zyphra/zonos-v0.1-hybrid", Label: "Zyphra Zonos Hybrid"},
							{Value: "sesame/csm-1b", Label: "Sesame CSM"},
							{Value: "canopylabs/orpheus-3b-0.1-ft", Label: "Canopy Orpheus"},
							{Value: "hexgrad/kokoro-82m", Label: "Hexgrad Kokoro"},
							{Value: "mistralai/voxtral-mini-tts-2603", Label: "Mistral Voxtral Mini TTS"},
						},
			...
			},
			{
				...
				Fields: []FieldMeta{
					{Key: "provider", Widget: WidgetSelect,
						Enum:    enumOptions("openai-whisper", tencentASRProvider, "openrouter"),
