...
func TestShouldCompressUsesResolverContextWindow8k(t *testing.T) {
	...
	mgr := NewMemoryManager("",
		...
		WithContextWindowFn(func() model.ModelSpec { return model.ModelSpec{ContextWindow: 8_000} }),
	)
...
func TestShouldCompressUsesResolverContextWindow32k(t *testing.T) {
	...
	mgr := NewMemoryManager("",
		WithExtractionConfig(cfg),
		WithContextWindowFn(func() model.ModelSpec { return model.ModelSpec{ContextWindow: 32_000} }),
	)
...
func TestShouldCompressUsesResolverContextWindow128k(t *testing.T) {
	...
	mgr := NewMemoryManager("",
		WithExtractionConfig(cfg),
		WithContextWindowFn(func() model.ModelSpec { return model.ModelSpec{ContextWindow: 128_000} }),
	)
...
func TestShouldCompressFallsBackToYAMLWhenResolverUnknown(t *testing.T) {
	...
	mgr := NewMemoryManager("",
		...
		WithContextWindowFn(func() model.ModelSpec { return model.ModelSpec{ContextWindow: 0} }),
	)
...
func TestMaintainFilesystemMemoryUsesResolverContextWindow(t *testing.T) {
	...
	mgr := NewMemoryManager(storageDir,
		WithExtractionConfig(cfg),
		WithContextWindowFn(func() model.ModelSpec { return model.ModelSpec{ContextWindow: 100_000} }),
	)
...
func TestShouldCompressReservesOutputTokens(t *testing.T) {
	...
	mgr := NewMemoryManager("",
		WithExtractionConfig(cfg),
		WithContextWindowFn(func() model.ModelSpec {
			return model.ModelSpec{ContextWindow: 10_000, MaxOutput: 2_000}
		}),
	)
