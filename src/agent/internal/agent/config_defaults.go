...
const (
	...
	DefaultNativeRealtimeVoiceInstructions = DefaultRealtimeVoiceCoreInstructions + "For device operation, screen inspection, external actions, or information that requires lookup, use the available direct tools and continue the request yourself; do not delegate to or mention a backend agent. "
