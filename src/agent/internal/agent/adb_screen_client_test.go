...
func TestADBScreenClientCapturesPNGAndJPEG(t *testing.T) {
	...
	pngMeta, pngFrame, err := client.LatestFrameWithFormat("png", screenshotJPEGQuality, false, 0)
	if err != nil {
	...
	jpegMeta, jpegFrame, err := client.LatestFrameWithFormat("jpeg", screenshotJPEGQuality, true, 0)
	if err != nil {
