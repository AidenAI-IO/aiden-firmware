...
const infrastructureStatusEl = document.getElementById('infrastructureStatus');
const infrastructureResultPanelEl = document.getElementById('infrastructureResultPanel');
const infrastructureResultMetaEl = document.getElementById('infrastructureResultMeta');
