...
// handleSTTTestStart and handleSTTTestStop expose the configuration test from
// Config Web. The Agent remains the runtime owner of recording and
// transcription; Config Web only validates the request and forwards it over
