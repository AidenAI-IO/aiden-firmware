...
- Coordinate-based call steps follow the same coordinate discipline as direct device operation: use implicit normalized 0-1000 coordinates without a `coord_space` field, and target the visible control center.
