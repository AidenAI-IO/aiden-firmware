...
The board-side launch tools accept semantic app names and HTTP/HTTPS webpage
URLs. The tools and companion app own transport selection and platform-specific
launch details.
