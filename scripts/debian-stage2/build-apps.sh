...
readonly OPENCV_SOURCE_CACHE=${DEBIAN_STAGE2_OPENCV_CACHE:-${REPO_ROOT}/.cache/debian-stage2/opencv}
...
Environment:
  ...
  DEBIAN_STAGE2_OPENCV_CACHE Persistent OpenCV-Mobile source archive cache.
